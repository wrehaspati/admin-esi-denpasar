...
export default function TransactionPage() {
  ...
  const confirmDelete = async (id: string) => {
    axiosInstance.delete('/admin/transaction/' + id.toString())
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage className="flex gap-2 items-center">Transaction{isLoading ? <LoadingSpinner className="size-4" /> : ""}</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 pt-0 md:w-full w-screen">
            <div className="min-h-[100vh] flex-1 rounded-xl md:min-h-min">
              ...
              <ActionDialog onRemoveConfirm={confirmDelete} dialogName="Transaction" />
            </div>
          </div>
        </SidebarInset>
      </DialogProvider>
