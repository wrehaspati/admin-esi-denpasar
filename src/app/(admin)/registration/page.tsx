            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage className="flex gap-2 items-center">Team Registration{isLoading ? <LoadingSpinner className="size-4" /> : ""}<Badge>Experimental</Badge></BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 pt-0 md:w-full w-screen">
            <div className="min-h-[100vh] flex-1 rounded-xl md:min-h-min">
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Fitur ini dalam tahap eksperimental, mohon berhati-hati dalam mencatat data yang ada. <br/> Data tercantum belum melalui tahap filterisasi dan validasi dengan transaksi yang telah lunas.
                </AlertDescription>
              </Alert>
